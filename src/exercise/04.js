...
function usePokemonResourceCache() {
  ...
  if (!context) {
    throw new Error(
      'PokemonResourceCacheContext must be used inside PokemonCacheProvider',
    )
  }
  return context
}
...
function App() {
  ...
  const getCachedPokemon = usePokemonResourceCache()
  ...
  React.useEffect(() => {
    ...
    startTransition(() => {
      setPokemonResource(getCachedPokemon(pokemonName))
    })
  }, [getCachedPokemon, pokemonName, startTransition])
