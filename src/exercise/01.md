...
When a component is wrapped in React.Suspense, it can throw a promise if its
data isn't available yet. When it will be, React will trigger a re-render of the
component so it can render with the fetched data.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Suspense%20%F0%9F%94%80&e=01%3A%20Simple%20Data-fetching&em=yoh.legrand%40gmail.com).
